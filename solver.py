...
def daisy(cube):
    ...
    while(not occupied_yellows['red'] or not occupied_yellows['green'] or
            not occupied_yellows['blue'] or not occupied_yellows['orange']):
